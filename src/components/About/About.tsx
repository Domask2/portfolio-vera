    ...
    <div className="about">
        <div className="about_wrapper wrapper">
            <div className="about_description">
                <p className='about_description__title'>Современный дизайн</p>
                <p className='about_description__text'>Веб-дизайн Графика Логотипы</p>
                <h1 className='about_description__great'>
                    Разработка дизайна как результат художественно-технического
                    проектирования
                </h1>
                <Button styleText={{color: 'black'}}>Получить консультацию</Button>
            </div>
