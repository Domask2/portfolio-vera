...
const MainElementSvg = ({className}: { className: string }) => (
    <svg className={className} width="800" height="800" viewBox="0 0 800 800">
        <path>
...
const SquareOneSvg = ({className}: { className: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 510" version="1.1">
        <title>Squares</title>
...
const SquareTwoSvg = ({className}: { className: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 510" version="1.1">
        <title>Squares</title>
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
...
export {MainElementSvg, SquareOneSvg, SquareTwoSvg}